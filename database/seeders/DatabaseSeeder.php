...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $gereedschap->save();
         ...
         $gereedschap->url = "https://nl.wikipedia.org/wiki/Beitel";
         $gereedschap->save(); 
        ...
        $songs->image = "/img/undisputed.jpg";
